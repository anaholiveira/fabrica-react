            ...
            <div className={styles.todasAsInformacoesFooter}>
                <div className={styles.cardFooter}>
                    ...
                    <div className={styles.displayInformacao}>
                        <Image className={styles.iconesFooter} src="/images/contato.jpeg" alt="Contato" width={25} height={25} />
                        <Link className={styles.contatofooter} href="/contato">Contato</Link>
                    </div>
